...
const PdfToWord: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/api/convert/pdf-to-word', {
                method: 'POST',
                body: formData,
            });
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div
                                className={`
                                    ...
                                    ${dragActive ? 'border-purple-400 bg-purple-50' : 'border-gray-300 hover:border-purple-400 hover:bg-gray-50'}
